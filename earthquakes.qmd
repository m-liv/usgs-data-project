...
To better understand these patterns, we analyzed global earthquake data from 2016 to March 2026, focusing on location, depth, and magnitude. By exploring both global trends and local behavior, this analysis reveals that while earthquakes are widespread, most are far less dramatic than we might expect, and only a small fraction pose significant risk.

## Where Earthquakes Happen

![](images/where_earthquakes_happen.png)
...
![](images/strongest_earthquakes.png)

Although most earthquakes are small, a few stand out as significantly stronger. These high-magnitude events are rare but concentrated in specific regions, often along major tectonic boundaries. One notable example is the Australian Plate, which has a boundary crossing through Indonesia exactly where some of the strongest earthquakes were seen in 2016. 

By examining the strongest earthquakes, we see that these events are not randomly distributed; instead, they tend to occur in areas already known for seismic activity. This reinforces the idea that while earthquakes are common, meaningful risk is concentrated in particular locations.
